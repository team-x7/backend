...
expots.register = asyncHandler(async (req, res, next) => {
...
expots.login = asyncHandler(async (req, res, next) => {
...
expots.getCurrentUser = asyncHandler(async (req, res) => {
 ...
 * @access  Public
 */
expots.forgotPassword = asyncHandler(async (req, res) => {
...
expots.verifyEmail = asyncHandler(async (req, res, next) => {
...
expots.resetPassword = asyncHandler(async (req, res) => {
